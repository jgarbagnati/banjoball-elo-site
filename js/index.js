...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_inferno_clone_vnode__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_history__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_path_to_regexp_es6__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_hoist_non_inferno_statics__ = __webpack_require__(21);
...
var StaticRouter = (function (Component$$1) {
    ...
    StaticRouter.prototype.render = function render () {
        ...
        return Object(__WEBPACK_IMPORTED_MODULE_0_inferno__["createComponentVNode"])(4 /* ComponentClass */, Router, Object.assign({}, props, { history: history })); // TODO: check these props types!
    };
...
var BrowserRouter = (function (Component$$1) {
    ...
    BrowserRouter.prototype.render = function render () {
        return Object(__WEBPACK_IMPORTED_MODULE_0_inferno__["createComponentVNode"])(4 /* ComponentClass */, Router, {
...
var Route = (function (Component$$1) {
    ...
    Route.prototype.render = function render () {
        ...
        if (component) {
            return match ? Object(__WEBPACK_IMPORTED_MODULE_0_inferno__["createComponentVNode"])(2 /* ComponentUnknown */, component, props) : null;
        }
        if (render) {
...
var Switch = (function (Component$$1) {
    ...
    Switch.prototype.render = function render () {
        ...
        return match ? Object(__WEBPACK_IMPORTED_MODULE_0_inferno__["createComponentVNode"])(child.flags, child.type, combineFrom(child.props, { location: location, computedMatch: match }), null, child.ref) : null;
    };
...
function Link(props, context) {
    ...
    return Object(__WEBPACK_IMPORTED_MODULE_0_inferno__["createVNode"])(1 /* HtmlElement */, 'a', className, children, 0 /* UnknownChildren */, Object.assign({}, rest, { href: href, onClick: Object(__WEBPACK_IMPORTED_MODULE_0_inferno__["linkEvent"])({
            context: context,
            props: props
...
function NavLink(_a) {
    ...
    return Object(__WEBPACK_IMPORTED_MODULE_0_inferno__["createComponentVNode"])(4 /* ComponentClass */, Route, {
    ...
    var C = function (props) {
        ...
        return Object(__WEBPACK_IMPORTED_MODULE_0_inferno__["createComponentVNode"])(4 /* ComponentClass */, Route, {
            render: function render(routeComponentProps) {
                return Object(__WEBPACK_IMPORTED_MODULE_0_inferno__["createComponentVNode"])(2 /* ComponentUnknown */, Com, combineFrom(remainingProps, routeComponentProps), null, wrappedComponentRef);
            }
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_resolve_pathname__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_value_equal__ = __webpack_require__(15);
...
var _NavbarTop = __webpack_require__(22);
...
var _Season = __webpack_require__(30);
...
var PLAYER_API = 'http://elo.banjoball.net:8080/api/players/';
var MATCH_API = 'http://elo.banjoball.net:8080/api/matches/';
...
var App = function (_Component) {
	...
	_createClass(App, [{
		...
		value: function componentDidMount() {
			...
			setTimeout(function () {
				xhrGet(PLAYER_API, function (data) {
					return _this2.onPlayers(data);
				});
			}, 100);
		}
	}, {
		...
		key: 'onPlayers',
		value: function onPlayers(data) {
			var _this4 = this;

			var playerList = JSON.parse(data);

			playerList.forEach(function (player) {
				_this4.state.playerMap[player.ID] = player;
				player.matches = [];
				if (player.win > 0 || player.loss > 0) {
					_this4.state.players.push(player);
				}
			});

			// Get match data
			xhrGet(MATCH_API, function (data) {
				return _this4.onMatches(data);
			});
		}
	}, {
		key: 'onMatches',
		value: function onMatches(data) {
			var _this5 = this;
			...
			matchList.forEach(function (match) {
				if (match.s1 == null || match.s2 == null) {
					_this5.state.ongoing.push(match);
				} else {
					_this5.state.matches.push(match);
				}
			});
					...
					children: [(0, _inferno.createComponentVNode)(2, _infernoRouter.Route, {
						...
						'render': function render() {
							return (0, _inferno.createComponentVNode)(2, _Home2.default, {
								'getPlayerById': _this6.getPlayerById,
								'players': _this6.state.players,
								'matches': _this6.state.matches,
								'ongoing': _this6.state.ongoing
							});
						}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createBrowserHistory__ = __webpack_require__(13);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__createBrowserHistory__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__createHashHistory__ = __webpack_require__(16);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_1__createHashHistory__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__createMemoryHistory__ = __webpack_require__(17);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_2__createMemoryHistory__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__LocationUtils__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__LocationUtils__ = __webpack_require__(4);
...
var _PlayersTable = __webpack_require__(25);

var _PlayersTable2 = _interopRequireDefault(_PlayersTable);

var _GamesTable = __webpack_require__(27);
...
var Home = function (_Component) {
	...
	_createClass(Home, [{
		...
		value: function onResize() {
			...
			if (window.innerWidth <= MAIN_CNTR_BREAKPOINT && this.state.width > MAIN_CNTR_BREAKPOINT || window.innerWidth > MAIN_CNTR_BREAKPOINT && this.state.width <= MAIN_CNTR_BREAKPOINT) {
				this.setState({});
			}
		...
		value: function render() {
			...
			var header = "Warcraft 3 Banjoball Elo, Season " + (this.state.currSeason + 1);
			if (pageWidth < 650) {
				if (pageWidth < 400) {
			...
			return (0, _inferno.createVNode)(1, 'div', null, [(0, _inferno.createVNode)(1, 'div', 'top-cntr', [(0, _inferno.createVNode)(1, 'div', 'header-cntr', header, 0), (0, _inferno.createVNode)(1, 'div', 'search-cntr', (0, _inferno.createComponentVNode)(2, _SearchBar2.default, {
...
var _PlayersTableRow = __webpack_require__(26);
...
var PlayersTable = function (_Component) {
	...
	_createClass(PlayersTable, [{
		...
		value: function onScroll() {
			...
			var offset = Math.max(18, Math.min(bnd.height - 75, Math.max(18, -bnd.top)) - 20);
			this.setState({
				offset: offset
			});
		}
		...
		value: function displayLeaderboardRows() {
			...
			var end = Math.min(this.props.players.length, (this.state.page + 1) * this.state.pageSize);
		...
		value: function render() {
			...
			return (0, _inferno.createVNode)(1, 'div', null, [(0, _inferno.createVNode)(1, 'div', null, [this.displayLeaderboardRows(), (0, _inferno.createVNode)(1, 'div', null, [(0, _inferno.createVNode)(1, 'div', 'rank', (0, _inferno.createTextVNode)(' Rank '), 2), (0, _inferno.createVNode)(1, 'div', 'name', (0, _inferno.createTextVNode)(' Name '), 2), (0, _inferno.createVNode)(1, 'div', 'elo', (0, _inferno.createTextVNode)(' Elo '), 2), (0, _inferno.createVNode)(1, 'div', 'winloss', (0, _inferno.createTextVNode)(' Win/Loss '), 2)], 4, {
				'id': 'player-table-header',
				'style': sticky
			})], 0, {
				'id': 'player-table-cntr-inner'
			}), (0, _inferno.createVNode)(1, 'div', 'player-table-title', (0, _inferno.createTextVNode)('Leaderboard'), 2)], 4, {
...
var _GamesTableRow = __webpack_require__(28);
...
var CurrentGamesTable = function (_Component) {
	...
	_createClass(CurrentGamesTable, [{
		...
		value: function onScroll() {
			...
			var bnd = cntr.getBoundingClientRect();
			var offset = Math.max(18, Math.min(bnd.height - 147, Math.max(18, -bnd.top)) - 20);
			this.setState({
				offset: offset
			});
		}
		...
		value: function displayMatchRows() {
			var rows = [];
			var start = this.state.page * this.state.pageSize;
			var end = Math.min(this.props.matches.length, (this.state.page + 1) * this.state.pageSize);
			for (var i = start; i < end; ++i) {
		...
		value: function render() {
			...
			return (0, _inferno.createVNode)(1, 'div', null, [(0, _inferno.createVNode)(1, 'div', null, [(0, _inferno.createVNode)(1, 'div', 'table-header', [(0, _inferno.createVNode)(1, 'div', 'match', (0, _inferno.createTextVNode)(' Match '), 2), (0, _inferno.createVNode)(1, 'div', 'team1', (0, _inferno.createTextVNode)(' Team 1 '), 2), (0, _inferno.createVNode)(1, 'div', 'scores', (0, _inferno.createTextVNode)(' Scores '), 2), (0, _inferno.createVNode)(1, 'div', 'team2', (0, _inferno.createTextVNode)(' Team 2 '), 2)], 4, {
				'style': sticky
			}), this.displayMatchRows()], 0, {
				'id': inner
			}), (0, _inferno.createVNode)(1, 'div', 'cntr-title', this.props.header, 0)], 4, {
				'id': outer
			});
		}
	}]);
...
var GamesTableRow = function (_Component) {
	...
	_createClass(GamesTableRow, [{
		...
		value: function render() {
			...
			return (0, _inferno.createVNode)(1, 'div', this.state.cntrClass, [(0, _inferno.createVNode)(1, 'div', 'match', this.props.match, 0), (0, _inferno.createVNode)(1, 'div', 'team1', [(0, _inferno.createVNode)(1, 'div', 'player', this.props.p1, 0), (0, _inferno.createVNode)(1, 'div', 'player', this.props.p2, 0), (0, _inferno.createVNode)(1, 'div', 'player', this.props.p3, 0), (0, _inferno.createVNode)(1, 'div', 'player', this.props.p4, 0)], 4), (0, _inferno.createVNode)(1, 'div', 'scores', this.state.scores, 0), (0, _inferno.createVNode)(1, 'div', 'team2', [(0, _inferno.createVNode)(1, 'div', 'player', this.props.p5, 0), (0, _inferno.createVNode)(1, 'div', 'player', this.props.p6, 0), (0, _inferno.createVNode)(1, 'div', 'player', this.props.p7, 0), (0, _inferno.createVNode)(1, 'div', 'player', this.props.p8, 0)], 4)], 4);
		}
	}]);
